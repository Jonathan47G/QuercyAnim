...
export default function Header() {
	...
	const boxLien = {
		boxClassName:
			"hover:border-iris-Border-ring-1 pl-3 pr-3 p-2 rounded hover:bg-gold-Interactive-1",
	};
	return (
		<header className="flex justify-between p-5 h-[80px] items-center w-full bg-iris-Background-1 border-b-4 border-[#444039]">
			...
			<nav>
				<ul className="grid grid-cols-4 gap-5 text-lg text-white font-extrabold divide-x-2 divide-[#444039]">
					...
					<li className={lienProps.lienClassName}>
						<Link href="/#Event" className={boxLien.boxClassName}>
							Événement
						</Link>
					</li>
					<li className={lienProps.lienClassName}>
